...
export const ALL_MODEL_PRESETS: ModelPreset[] = [
  {
    ...
    pricing: "Free Tier (1,500 RPD free) / Paid $0.75 per 1M tokens (~$0.0025 / clip)",
    speed: "Ultra-fast",
    accuracy: "Maximum",
    summary: "Google's most capable Flash model for agentic workflows, multi-step analysis, and advanced multimodal reasoning.",
  ...
  },
  {
    ...
    badge: "Lowest Cost",
    badgeType: "recommended",
    pricing: "Free Tier (1,500 RPD free) / Paid $0.10 per 1M tokens (~$0.00035 / clip)",
    speed: "Instant",
    accuracy: "High",
    summary: "Optimized for cost-efficiency, high throughput, and high visual quality across large archives.",
    requirements: "Google Gemini API key",
  },
  {
    id: "gemini-2.5-flash",
    ...
    badgeType: "default",
    pricing: "Free Tier (1,500 RPD free) / Paid $0.15 per 1M tokens (~$0.0005 / clip)",
    speed: "Ultra-fast",
    accuracy: "Very High",
    summary: "Proven balanced multimodal workhorse model with high speed and visual comprehension.",
    requirements: "Google Gemini API key",
  },
  {
    id: "gemini-3.1-pro",
    ...
    badgeType: "pro",
    pricing: "Paid $2.00 per 1M tokens",
    speed: "Moderate",
    accuracy: "Maximum",
    summary: "Google's flagship deep reasoning vision model with 2M+ token context for complex and nuanced video analysis.",
    requirements: "Google Gemini API key",
  },
  {
    id: "gpt-4o-mini",
