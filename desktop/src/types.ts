...
export const ALL_MODEL_PRESETS: ModelPreset[] = [
  {
    ...
    speed: "Ultra-fast",
    accuracy: "Very High",
    summary: "Google's latest fast multimodal model. Exceptional visual recognition, action understanding, and on-screen text reading at ultra-low cost.",
  ...
  },
  {
    ...
    speed: "Real-time",
    accuracy: "High",
    summary: "Ultra low-latency multimodal model. Optimized for rapidly scanning large video archives.",
    requirements: "Google Gemini API key",
  },
  {
    id: "gpt-4o-mini",
